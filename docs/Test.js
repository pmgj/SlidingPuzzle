...
try {
    ...
    p.move(new Cell(2, 2), new Cell(1, 2));
    p.move(new Cell(1, 2), new Cell(0, 2));
    p.move(new Cell(1, 1), new Cell(2, 2));
    p.move(new Cell(1, 0), new Cell(2, 2));
    console.error();
} catch (ex) {

}
p.move(new Cell(1, 2), new Cell(2, 2));
p.move(new Cell(1, 1), new Cell(1, 2));
